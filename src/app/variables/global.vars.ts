import {
  InventoryTabs, Category, Warehouse,
...
export const RECEIVING_DATA: Receiving[] = [
  {
    item: {
      photos: { title: t, main: `${f}`, alternatives: [] },
      name: 'Purple Fork', sku: 'pplfork', locationList: [1, 2, 3, 4], serial_s: null
...
export const LIBRARY_LIBMAP_TABS: InventoryTabs[] = [
  // library tabs
  { svg: 'addlibrary', icon: 'local_library', name: 'Νέα Βιβλιοθήκη', id: 'addlib' },
  { svg: 'bookcase', icon: '', name: 'Χαρτογράφηση Βιβλιοθήκης', id: 'bookcase' },
...
export const LIBRARY_BOOK_TABS: InventoryTabs[] = [
  // library tabs
  { svg: 'allbooks', icon: '', name: 'Όλα τα βιβλία', id: 'list' },
  /* { svg: 'addlibrary', icon: 'local_library', name: 'Δημιουργία Βιβλιοθήκης', id: 'addlibrary' }, */
  { svg: 'book', icon: 'book-medical', name: 'Προσθήκη Βιβλίου', id: 'add' },
...
export const LIBRARY_ITEMS: InventoryTabs[] = [
  // library tabs
  { svg: 'map', icon: '', name: 'Χωροθέτηση', id: 'map' },
  { svg: 'books', icon: '', name: 'Βιβλία', id: 'book' },
