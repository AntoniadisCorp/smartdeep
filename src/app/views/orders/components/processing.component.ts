...
import { ITEM_DATA, MENUBTN_ORDER_PROCESS, ACTIONBTN_ORDER_PROCESS } from 'src/app/variables';
...
export class ProcessingComponent implements OnInit {
    ...
    displayedColumns: string[] = ['select', 'store', 'order', 'date', 'customer',
        'status', 'tags', 'Method']; // 'tags', 'distributors', 'fullfillmentSKU', 'onhand', 'status
    ...
    ngOnInit(): void {
        ...
        this.MenuTools = MENUBTN_ORDER_PROCESS;
        this.ActionBtn = ACTIONBTN_ORDER_PROCESS;
